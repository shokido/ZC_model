...
for iy in range(iy1,iy2):
    fnames_in.append(dir_in+"jra55do_v1.3_u10_"+str(iy)+"_monthly.nc")
    fnames_out.append("jra55do_v1.3_u10_"+str(iy)+"_ocn_"+grd_name+".nc")
    fnames_in.append(dir_in+"jra55do_v1.3_v10_"+str(iy)+"_monthly.nc")
    fnames_out.append("jra55do_v1.3_v10_"+str(iy)+"_ocn_"+grd_name+".nc")
