...
dir_io="../..//OUTPUTS/SPIN/"
fflag="bulk_H120_cd_1.5_1_20"
fflag="bulk_H130_cd_1.8_1_20"
#fflag="bulk_H150_cd_2.05_1_20"
#fflag="bulk_H150_cd_2.25_1_20"
#fflag="bulk_H130_cd_2.0_1_20"

#fflag="bulk_H120_cd_1.8_1_20"
#fflag="bulk_H120_cd_2.0_1_20"
...
sst_base_ann=np.nanmean(sst_base,axis=0)
time_out=[]
...
u_base_ann=np.nanmean(u,axis=0)
v_base_ann=np.nanmean(v,axis=0)
w_base_ann=np.nanmean(w,axis=0)
h_base_ann=np.nanmean(h,axis=0)
