...
contains
  ...
  subroutine create_diag_ocn_ZC(fname,ogrd,&
    ...
    call add_var_att(trim(fname),"lon_p","long_name","longitude on p-grid")
    call add_var_att(trim(fname),"lon_p","units","degrees_east")
    call writenet_def_var(trim(fname),1,1,(/"y_p"/),(/"lat_p"/),(/"double"/))
    call add_var_att(trim(fname),"lat_p","long_name","latitude on p-grid")
    call add_var_att(trim(fname),"lat_p","units","degrees_north")
    call writenet_def_var(trim(fname),1,1,(/"x_u"/),(/"lon_u"/),(/"double"/))
    call add_var_att(trim(fname),"lon_u","long_name","longitude on u-grid")
    call add_var_att(trim(fname),"lon_u","units","degrees_east")
    call writenet_def_var(trim(fname),1,1,(/"y_u"/),(/"lat_u"/),(/"double"/))
    call add_var_att(trim(fname),"lat_u","long_name","latitude on u-grid")
    call add_var_att(trim(fname),"lat_u","units","degrees_north")
    call writenet_def_var(trim(fname),1,1,(/"x_v"/),(/"lon_v"/),(/"double"/))
    call add_var_att(trim(fname),"lon_v","long_name","longitude on v-grid")
    call add_var_att(trim(fname),"lon_v","units","degrees_east")
    call writenet_def_var(trim(fname),1,1,(/"y_v"/),(/"lat_v"/),(/"double"/))
    call add_var_att(trim(fname),"lat_v","long_name","latitude on v-grid")
    call add_var_att(trim(fname),"lat_v","units","degrees_north")
